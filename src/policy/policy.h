...
static constexpr uint32_t STANDARD_SCRIPT_VERIFY_FLAGS =
    ...
    SCRIPT_VERIFY_SIGPUSHONLY | SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_NOPS |
    SCRIPT_VERIFY_CHECKLOCKTIMEVERIFY | SCRIPT_DISALLOW_SEGWIT_RECOVERY |
    SCRIPT_VERIFY_CHECKSEQUENCEVERIFY | SCRIPT_VERIFY_INPUT_SIGCHECKS;
