...
BOOST_AUTO_TEST_CASE(bip341_verify_pubkey_tweak_add) {
    std::vector<uint8_t> vch_base, vch_tweaked;
    uint256 tweak;
    CPubKey pubkey_base, pubkey_tweaked;
    ...
    BOOST_CHECK(pubkey_tweaked.VerifyPubkeyTweakAdd(pubkey_base, tweak));
