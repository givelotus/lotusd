...
BOOST_AUTO_TEST_CASE(type_conversion_test) {
    ...
    // BIN2NUM.
    CheckBin2NumError({{0xab, 0xcd, 0xef, 0xc2, 0xab, 0xcd, 0xef, 0xc2, 0x80}},
...
BOOST_AUTO_TEST_CASE(div_and_mod_opcode_tests) {
    ...
    CheckDivMod({0x01, 0x02, 0x03, 0x04, 0x05}, {0x01, 0x02, 0x03, 0x04, 0x05},
                {0x01}, {});
    CheckDivMod({0x01, 0x02, 0x03, 0x04, 0x05}, {0x01},
                {0x01, 0x02, 0x03, 0x04, 0x05}, {});
    CheckDivMod({0x01, 0x05}, {0x01, 0x02, 0x03, 0x04, 0x05},
                {}, {0x01, 0x05});
