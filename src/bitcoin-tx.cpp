...
static const struct {
    ...
    {"ALL|BIP341|FORKID", SIGHASH_ALL | SIGHASH_BIP341 | SIGHASH_FORKID},
    {"NONE|BIP341|FORKID", SIGHASH_NONE | SIGHASH_BIP341 | SIGHASH_FORKID},
    {"SINGLE|BIP341|FORKID", SIGHASH_SINGLE | SIGHASH_BIP341 | SIGHASH_FORKID},
    {"ALL|BIP341|FORKID|ANYONECANPAY",
     SIGHASH_ALL | SIGHASH_BIP341 | SIGHASH_FORKID | SIGHASH_ANYONECANPAY},
    {"NONE|BIP341|FORKID|ANYONECANPAY",
     SIGHASH_NONE | SIGHASH_BIP341 | SIGHASH_FORKID | SIGHASH_ANYONECANPAY},
    {"SINGLE|BIP341|FORKID|ANYONECANPAY",
     SIGHASH_SINGLE | SIGHASH_BIP341 | SIGHASH_FORKID | SIGHASH_ANYONECANPAY},
};
