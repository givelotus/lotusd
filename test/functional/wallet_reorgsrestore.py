...
class ReorgsRestoreTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        nA = next(tx_out["vout"] for tx_out in self.nodes[0].gettransaction(
            txid_conflict_from)["details"] if tx_out["amount"] == Decimal('1'))
        inputs = []
        ...
        outputs_1[self.nodes[0].getnewaddress()] = Decimal('0.99998')
        outputs_2[self.nodes[0].getnewaddress()] = Decimal('0.99998')
