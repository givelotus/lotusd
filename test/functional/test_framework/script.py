...
OP_RAWLEFTBITSHIFT = CScriptOp(0x98)
OP_MULPOW2 = CScriptOp(0x99)
...
OP_LOOP = CScriptOp(0xbd)
OP_ENDLOOP = CScriptOp(0xbe)

# introspection opcodes
OP_THISINDEX = CScriptOp(0xbf)
OP_NUMPREAMBLES = CScriptOp(0xc0)
OP_NUMINPUTS = CScriptOp(0xc1)
OP_NUMOUTPUTS = CScriptOp(0xc2)
OP_PICKPREAMBLEHASH = CScriptOp(0xc3)
OP_PICKINPUTOUTPOINT = CScriptOp(0xc4)
OP_PICKINPUTVALUE = CScriptOp(0xc5)
OP_PICKINPUTSCRIPTPUBKEY = CScriptOp(0xc6)
OP_PICKINPUTCARRYOVER = CScriptOp(0xc7)
OP_PICKINPUTPREAMBLEMERKLEROOT = CScriptOp(0xc8)
OP_PICKOUTPUTVALUE = CScriptOp(0xc9)
OP_PICKOUTPUTSCRIPTPUBKEY = CScriptOp(0xca)
OP_PICKOUTPUTCARRYOVER = CScriptOp(0xcb)
...
OPCODE_NAMES.update({
    ...
    OP_DIV: 'OP_DIV',
    OP_MOD: 'OP_MOD',
    OP_RAWLEFTBITSHIFT: 'OP_RAWLEFTBITSHIFT',
    OP_MULPOW2: 'OP_MULPOW2',
    ...
    OP_THISINDEX: 'OP_THISINDEX',
    OP_NUMPREAMBLES: 'OP_NUMPREAMBLES',
    OP_NUMINPUTS: 'OP_NUMINPUTS',
    OP_NUMOUTPUTS: 'OP_NUMOUTPUTS',
    OP_PICKPREAMBLEHASH: 'OP_PICKPREAMBLEHASH',
    OP_PICKINPUTOUTPOINT: 'OP_PICKINPUTOUTPOINT',
    OP_PICKINPUTVALUE: 'OP_PICKINPUTVALUE',
    OP_PICKINPUTSCRIPTPUBKEY: 'OP_PICKINPUTSCRIPTPUBKEY',
    OP_PICKINPUTCARRYOVER: 'OP_PICKINPUTCARRYOVER',
    OP_PICKINPUTPREAMBLEMERKLEROOT: 'OP_PICKINPUTPREAMBLEMERKLEROOT',
    OP_PICKOUTPUTVALUE: 'OP_PICKOUTPUTVALUE',
    OP_PICKOUTPUTSCRIPTPUBKEY: 'OP_PICKOUTPUTSCRIPTPUBKEY',
    OP_PICKOUTPUTCARRYOVER: 'OP_PICKOUTPUTCARRYOVER',
