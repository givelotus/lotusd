...
"""Test objects for interacting with a lotusd node over the p2p protocol.

The P2PInterface objects interact with the lotusd nodes under test using the
...
MAGIC_BYTES = {
    "mainnet": b"\xec\xe7\xef\xf3",
    "testnet3": b"\xec\xf4\xf3\xf4",
    "regtest": b"\xec\xf2\xe5\xe7",
}
