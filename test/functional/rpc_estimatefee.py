...
class EstimateFeeTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            [],
            ["-minrelaytxfee=0.1"],
            ["-mintxfee=0.002", "-maxtxfee=0.0025"],
        ]
