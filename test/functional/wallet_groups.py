...
class WalletGroupTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            ...
            [],
            ['-avoidpartialspends'],
            # 2.93 XPI is the threshold that causes a node to prefer a
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(addr_aps, Decimal('1.0'))
        self.nodes[0].sendtoaddress(addr_aps, Decimal('1.0'))
        self.nodes[0].generate(1)
        self.sync_all()
        ...
        [self.nodes[0].sendtoaddress(addr_aps2, 1) for _ in range(5)]
        self.nodes[0].generate(1)
        self.sync_all()
        ...
        [self.nodes[0].sendtoaddress(addr_aps3, 1) for _ in range(5)]
        self.nodes[0].generate(1)
        self.sync_all()
