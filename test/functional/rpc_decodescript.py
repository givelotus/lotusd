...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decoderawtransaction_asm_sighashtype(self):
        ...
        rpc_result = self.nodes[0].decoderawtransaction(tx)
        assert_equal(
            'd25f09c5a591184245005203c69bf1c88932dda274428bb003f91fcb7232daf2', rpc_result['txid'])
        assert_equal(
            '8e3730608c3b0bb5df54f09076e196bc292a8e39a78e73b44b6ba08c78f5cbb0', rpc_result['hash'])
        assert_equal(
