...
1. Clone the Lotus source code and cd into `lotusd`
...
2.  Build Lotus Core:
    ...
    Configure and build the headless Lotus binaries as well as the GUI.
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Lotus may be compiled in
...
Lotus is now available at `./src/lotusd`
