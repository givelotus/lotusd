...
3. Verify tests passed
    ...
    - Ensure that lotusd and lotus-qt run with no issue on all supported platforms.
      Manually test lotus-qt by sending some transactions and navigating through the menus.
